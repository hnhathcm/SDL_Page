...
const portfolioData ={
  "en": [
    ...
    { title: "Inflow", category: "Supply Chain", desc: "Vietnam's first B2B on-demand fashion supply chain platform for global brands. Strategic infrastructure development.", metric: "On-demand Fashion Manufacturing", img: "https://asiatechdaily.com/wp-content/uploads/2023/11/inflow-COVER.jpg" },
    { title: "Levents Global", category: "Consumer", desc: "Leading GenZ fashion brand with significant regional footprint and exclusive Sanrio collaborations.", metric: "Top Local Brand for GenZ in Vietnam", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDj5p1GI2bCRFsDQ5EiurYz8qQlk2eC3akZbgyYegrEKYfBvAPZ2hDGvGw-nYSEFD-2avU-sYbI5jSW28Qzso62sGGnfwd0QfokmN30WBZVDaQMoD_YNeXnQq2zJiFuOlYg29dX8mlQ-6SkelZ_566gT3kiJD_eyEO6qfP994Nx1FnYQEhhFyhnLzRqZ7mdgM1ptfYJroRRmbLml-TLNeo2JPgFHhhT_yY9NqbPefUISW_CFKNjhFdgLtEZhv-rmVnZB86PCCUhy6sr" },
    { title: "Finfan", category: "Fintech", desc: "Supporting the next generation of international payment infrastructure. Series A Facilitation. VC Network Access.", metric: "Foreign Currencies Acceptance and Payment Fintech", img: "https://merchant-uat.finfan.io/logo-black.png" },
    { title: "Sazi Home", category: "Hospitality", desc: "Innovative lifestyle and hospitality brand.", metric: "Hotels chain", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAXVrsFWMSu-Kqh6PTpyw4f2WJxMzzy7eHmQ3sv6ncRqHx70le6DCm-TE4w-MQgp7qGyOj0xsZm3l_K-OFdNCJNmYg6U1DxIZTB01sAyx86Jbl0OJXk9dYhuoMUWP9et9a0v6dpjmnqVFX-97C3AsHRR8393QSJkprZ-DV2CpaKycI6xiiAIVN0gg5kgySB0UVtrgbb3dX6gJwXwM88ksCDU6svPhPXclGM2ffSIqRDoThLFZpVDqOKUqtWQKpXi1lLD_7C6PI4cI8L" },
    { title: "Apptronik", category: "Robotics", desc: "Scaling Apollo humanoid robots with backing from B Capital and Google. Pioneering general-purpose robotics.", metric: "Humanoid Robot", img: apptronikImg },
    { title: "Blitz", category: "EV Logistics", desc: "Indonesian EV logistics company. Supporting capital raising and strategic business development.", metric: "EV bike delivery platform in Indonesia (membership of NVIDIA Inception Program)", img: "https://www.third-derivative.org/hubfs/blitz-logoArtboard%201.png" }
  ],
  "vi": [
    ...
    { title: "Inflow", category: "Supply Chain", desc: "Nền tảng chuỗi cung ứng thời trang B2B on-demand đầu tiên tại Việt Nam dành cho thương hiệu toàn cầu. Phát triển hạ tầng chiến lược.", metric: "Sản xuất thời trang theo yêu cầu", img: "https://asiatechdaily.com/wp-content/uploads/2023/11/inflow-COVER.jpg" },
    { title: "Levents Global", category: "Consumer", desc: "Thương hiệu thời trang GenZ hàng đầu với độ phủ khu vực mạnh mẽ và các collaboration độc quyền cùng Sanrio.", metric: "Thương hiệu nội địa hàng đầu cho GenZ tại Việt Nam", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDj5p1GI2bCRFsDQ5EiurYz8qQlk2eC3akZbgyYegrEKYfBvAPZ2hDGvGw-nYSEFD-2avU-sYbI5jSW28Qzso62sGGnfwd0QfokmN30WBZVDaQMoD_YNeXnQq2zJiFuOlYg29dX8mlQ-6SkelZ_566gT3kiJD_eyEO6qfP994Nx1FnYQEhhFyhnLzRqZ7mdgM1ptfYJroRRmbLml-TLNeo2JPgFHhhT_yY9NqbPefUISW_CFKNjhFdgLtEZhv-rmVnZB86PCCUhy6sr" },
    { title: "Finfan", category: "Fintech", desc: "Hỗ trợ thế hệ hạ tầng thanh toán quốc tế tiếp theo. Hỗ trợ Series A, kết nối mạng lưới VC và cố vấn founder.", metric: "Fintech Chấp Nhận Và Thanh Toán Ngoại Tệ", img: "https://merchant-uat.finfan.io/logo-black.png" },
    { title: "Sazi Home", category: "Hospitality", desc: "Thương hiệu lifestyle và hospitality.", metric: "Chuỗi khách sạn", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAXVrsFWMSu-Kqh6PTpyw4f2WJxMzzy7eHmQ3sv6ncRqHx70le6DCm-TE4w-MQgp7qGyOj0xsZm3l_K-OFdNCJNmYg6U1DxIZTB01sAyx86Jbl0OJXk9dYhuoMUWP9et9a0v6dpjmnqVFX-97C3AsHRR8393QSJkprZ-DV2CpaKycI6xiiAIVN0gg5kgySB0UVtrgbb3dX6gJwXwM88ksCDU6svPhPXclGM2ffSIqRDoThLFZpVDqOKUqtWQKpXi1lLD_7C6PI4cI8L" },
    { title: "Apptronik", category: "Robotics", desc: "Mở rộng robot hình người Apollo với sự hậu thuẫn từ B Capital và Google. Tiên phong trong robotics đa mục đích.", metric: "Robot hình người", img: apptronikImg },
    { title: "Blitz", category: "EV Logistics", desc: "Công ty logistics EV tại Indonesia. Hỗ trợ gọi vốn và phát triển chiến lược kinh doanh để mở rộng khu vực.", metric: "Nền tảng giao hàng xe điện tại Indonesia (thành viên của chương trình NVIDIA Inception)", img: "https://www.third-derivative.org/hubfs/blitz-logoArtboard%201.png" }
  ]
};
