...
import inflowImg from "../assets/inflow.webp";
...
const portfolioData ={
  "en": [
    ...
    { title: "Inflow", category: "Supply Chain", desc: "Vietnam's first B2B on-demand fashion supply chain platform for global brands. Strategic infrastructure development.", metric: "On-demand Fashion Manufacturing", img: inflowImg },
  ...
  "vi": [
    ...
    { title: "Inflow", category: "Supply Chain", desc: "Nền tảng chuỗi cung ứng thời trang B2B on-demand đầu tiên tại Việt Nam dành cho thương hiệu toàn cầu. Phát triển hạ tầng chiến lược.", metric: "Sản xuất thời trang theo yêu cầu", img: inflowImg },
