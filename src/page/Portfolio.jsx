    ...
    <main className="bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8">
            ...
            <h1 className="font-display-lg text-6xl md:text-[84px] leading-none mb-8 text-brand-navy">
              <span className="italic font-normal">Building the Future</span> of Growth.
            </h1>
          </div>
          <div className="md:col-span-4 flex flex-col justify-end">
            <p className="font-body-lg text-on-surface-variant mb-6 border-l-2 border-secondary pl-6">
              A record of strategic support, capital facilitation, and operational excellence across Southeast Asia and global markets.
            </p>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 border-t border-outline-variant/10">
        <div className="max-w-[1280px] mx-auto px-6 flex flex-col items-center text-center">
          <h2 className="font-headline-md text-2xl mb-8 text-[#04044A]">Ready to accelerate your next venture?</h2>
