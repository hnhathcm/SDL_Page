    ...
    <main className="max-w-[1280px] mx-auto px-6">
      ...
      <section className="mb-24">
        <div className="bg-surface-container-low rounded-xl p-12 md:p-20 border border-outline-variant/10 text-center max-w-4xl mx-auto shadow-sm">
          <span className="font-label-caps text-secondary uppercase mb-4 block">THE WEEKEND BRIEF</span>
          <h2 className="text-4xl font-display-lg text-[#04044A] mb-6">Stay ahead with the architecture of growth.</h2>
          <form className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
            ...
            <button className="bg-[#04044A] text-white px-8 py-3 rounded-lg font-bold hover:opacity-90 transition-all">Subscribe</button>
          </form>
        </div>
      </section>
    </main>
