...
import Nhat from "../assets/Nhat.webp";
const About = () => {
  const {lang} = useLanguage();
  const navigate = useNavigate();
  const team ={
    "en":[
    { name: "Hoang Nhat (Leo)", role: "CO-FOUNDER", img:Nhat, bio: "Ex-Managing Director of Godee" },
    ...
    { name: "Hoang William", role: "LAWYER PARTNER", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBIOKU8EgoLv7P0RbVxHBZI3WJYLdMCyXpm1wTrnzPJ3V23P1IWeWN0Ti78mJAfNuz4I7La7T_5eXS0_ep4CM8IDlx0O2z_fB9ZFyFJF4NmukU5cYzARQoOstaD0FIR37nFNSiQL62j5gZqM3SDyfRX-V6ym70HBIZbqdhEEiSLcQssCFFkrk5ubSBV1zTSua-h3u9F9jxte62rrmfjyfPZj0dvcspVQGPbEqa2W-CcsY9kUF5lvouu5BesgwVcB1Gd4sK8Wra_721LcSA", bio: "MBA - Lawyer. Managing Partner of CBL Law Firm 16+ years of experience in corporate and investment law, project, and internet law." },
    ...
    "vi":[
      ...
      { name: "Le Hoang Phuong", role: "ĐỐI TÁC CHƯƠNG TRÌNH DOANH NGHIỆP", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAUciP8g7DP9rwBiLIsL2FMvbsuLnU40q6Y_yz3dKAGFKACQo1ia0lveYd6Fc-dptMIDh54bBElHwezcopqOfLpsiSKA_oqGuFcMHk-aKK1O4WzhIdkTz3soeZ4rYZ25pSAIrDtU-C7jVazaP-Qjc48JTegHqFCO0amaXkWbQJnre8nk_C_4LVCh0tfu9ZQ8iFtuoJT_NDI14L2oNi5t0yk8pWU4cnyzEmtwUSqZYZZQiNkLwX56LDgoTJESJ-c4s34EOVrAyWQrwExp3U", bio: "Head of Association Relations and Intel Program Manager tại SGSI. Giảng viên Experiential Entrepreneurship tại FPT University. Senior Business Development Executive tại Selix Motors." },
